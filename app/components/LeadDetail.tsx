...
const scoreBreakdown = [
  {
    ...
    pts: 35,
    color: '#2563EB',
    description: 'Viewed 650 Maple St 4 times today, saved it',
  },
  {
    icon: '📧',
    ...
    pts: 28,
    color: '#7c3aed',
    description: 'Opened last 2 emails within 10 minutes',
  },
  {
    icon: '🔄',
    label: 'Return Visit',
    pts: 20,
    color: '#059669',
    description: 'Back on site today after 6-day absence',
  },
  {
    icon: '📞',
    ...
    pts: 9,
    color: '#d97706',
    description: 'Valid phone, verified email',
  },
]
        ...
        <div className="max-w-2xl mx-auto px-6 py-8 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm animate-fade-in">
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-900">Scott Hayes</h2>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs text-gray-500">92 / 100 points</span>
              </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm animate-fade-in" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="flex gap-2 mt-3">
              ...
              <button
                onClick={() => {
                  setToast('Text sent to Scott Hayes!')
                  setEditMode(false)
                }}
